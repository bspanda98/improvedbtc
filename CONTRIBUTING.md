Contributing to ImprovedbitCoin Core
==================================

The ImprovedbitCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ImprovedbitCoin Core project, and is not to be
confused with overall ImprovedbitCoin Network Protocol consensus changes.

Whether a pull request is merged into ImprovedbitCoin Core rests with the project merge
...
Patches that change ImprovedbitCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the ImprovedbitCoin consensus, it must have been
...
The project leader is the release manager for each ImprovedbitCoin Core release.
