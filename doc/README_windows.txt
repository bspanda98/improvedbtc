...
Intro
-----
ImprovedbitCoin (IBTC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. ImprovedbitCoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run improvedbitcoin-qt.exe.

ImprovedbitCoin Core is the original ImprovedbitCoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of ImprovedbitCoin transactions;
