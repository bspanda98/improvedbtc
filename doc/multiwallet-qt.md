...
In order to support loading of multiple wallets in improvedbitcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is improvedbitcoin.cpp.
...
Changes to improvedbitcoin.cpp
----------------------
improvedbitcoin.cpp is the entry point into improvedbitcoin-qt, and as such, will require some minor modifications to provide hooks for
