...
/** Utility functions used by the ImprovedbitCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render IBTC addresses in monospace font
...
// Parse "improvedbitcoin:" URI into recipient object, return true on successful parsing
