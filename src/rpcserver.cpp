...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop ImprovedbitCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "ImprovedbitCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ImprovedbitCoin features */
        {"improvedbitcoin", "masternode", &masternode, true, true, false},
        ...
        {"improvedbitcoin", "mnbudget", &mnbudget, true, true, false},
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:1947/\n";
}
