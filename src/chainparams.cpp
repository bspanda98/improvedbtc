...
// Copyright (c) 2019 The ImprovedbitCoin developers
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1587131253, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nTargetSpacing = 1 * 60;  // ImprovedbitCoin: 2 minute blocks during POW (block 1-200)
        nMaturity = 5; // 6 block maturity (+1 elsewhere)
        nMasternodeCountDrift = 20;
        nMaxMoneyOut = 21000000 * COIN; // 21 million max supply
        nLastPOWBlock = 700000;
        nModifierUpdateBlock = 1; // we use the version 2 for IBTC

        const char* pszTimestamp = "ImprovedbitCoin is live - zabtc 17/04/2020";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1587131253;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 21720758;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000d48cedd059911b1e4a90a8b8cb6efdcbd79f837e13b11b26aa1957eea50"));
        assert(genesis.hashMerkleRoot == uint256("0x8a0d267a72be628cba782e044937f93c12c0bb78e3bbac1e8153c63d91af81a2"));

        // ImprovedbitCoin addresses start with 'i'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 33);
        // ImprovedbitCoin script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 6);
        // ImprovedbitCoin private keys start with 'K'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 46);
        // ImprovedbitCoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // ImprovedbitCoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // ImprovedbitCoin BIP44 coin type is '222' (0x800000de)
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // ImprovedbitCoin: 1 day
        nTargetSpacing = 2 * 60;  // ImprovedbitCoin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
       ...
       // assert(hashGenesisBlock == uint256("0x000008467c3a9c587533dea06ad9380cded3ed32f9742a6c0c1aebc21bf2bc9b"));
        ...
        // Testnet ImprovedbitCoin addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet ImprovedbitCoin script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet ImprovedbitCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet ImprovedbitCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet improvedbitcoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nTargetSpacing = 2 * 60;        // ImprovedbitCoin: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1516926684;
